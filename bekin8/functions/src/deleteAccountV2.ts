...
/** Delete by query with operator support (==, array-contains, in, array-contains-any). */
type Op = FirebaseFirestore.WhereFilterOp;
async function deleteByQuery(colPath: string, field: string, op: Op, value: any, pageSize = 300) {
  try {
    while (true) {
