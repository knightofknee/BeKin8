...
// The log shapes ONLY (no <Svg> wrapper), authored in a 0..100 coordinate space so they can be
// composed inside another <Svg>. UnlitLogs (below) wraps these in their own <Svg> for standalone use.
...
// Standalone static logs (its own <Svg>). Each log = a rotated trunk + a cut-end circle; logs lean
// inward to a point at the top. The original "Campfire" beacon structure.
